...
def main():
    ...
    #authorization codes for 4 fake users
    header1 = {
    ...
    temp = 0
    temp += user1.json()['data']['items'][0]['details']['active_time']
    temp += user1.json()['data']['items'][1]['details']['active_time']

    print ("Active time " + str(temp / 60))
